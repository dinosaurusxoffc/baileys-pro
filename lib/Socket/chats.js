...
export const makeChatsSocket = (config) => {
    ...
    // dino@Note 06-02-26 --- Quick helper only. This function exists solely for faster lookup with caching.
    const findUserId = async (pnLid) => {
        ...
        if (isPnUser(pnLid)) {
            ...
            if (!userId.lid) {
                ...
                return userId; // dino@Note 06-02-26 --- Early return to skip caching for non-existent ID
            }
        }
        ...
        // dino@Note 06-02-26 --- I know... it's dirty (⁠╯⁠︵⁠╰⁠,⁠)
    ...
    const profilePictureUrl = async (jid, type = 'image', timeoutMs) => {
        // dino@Changes 06-02-26 --- Refactor profilePictureUrl() to use tctoken and adjust error handling
